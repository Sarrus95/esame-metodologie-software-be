...
userRouter.post("/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newUser = Object.assign(Object.assign({}, req.body), { password: (0, bcrypt_ts_1.hashSync)(req.body.password), emailAuthToken: (0, uuid_1.v4)() });
...
userRouter.get("/auth-email/:token", EmailTokenVerifier_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
userRouter.post("/login", UserLoginVerifier_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
